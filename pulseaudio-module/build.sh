...
$CC -O2 -shared $CFLAGS $LDFLAGS -lpulsecore-13.0 -lpulsecommon-13.0 -lpulse -laaudio -o build64/module-aaudio-sink.so module-aaudio-sink.c
...
$CC -O2 -shared $CFLAGS $LDFLAGS -lpulsecore-13.0 -lpulsecommon-13.0 -lpulse -laaudio -o build/module-aaudio-sink.so module-aaudio-sink.c